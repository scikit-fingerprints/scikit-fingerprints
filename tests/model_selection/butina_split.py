...
from skfp.model_selection.splitters.butina_split import butina_train_test_split
...
def test_butina_train_test_split_default(all_molecules):
    train, test = butina_train_test_split(all_molecules)
    assert len(train) == 8
    assert len(test) == 2
