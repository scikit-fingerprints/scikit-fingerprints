...
from skfp.utils.splitters import scaffold_train_test_split, scaffold_train_valid_test_split, _create_scaffolds
...
def test_train_test_split_total_molecule_count(all_molecules):
    train_split, test_split = scaffold_train_test_split(all_molecules, 
                                            train_size=0.8, 
                                            test_size=0.2)
