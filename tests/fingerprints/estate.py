...
def test_estate_bit_sparse_fingerprint(smiles_list, mols_list):
...
def test_estate_count_sparse_fingerprint(smiles_list, mols_list):
...
def test_estate_sum_sparse_fingerprint(smiles_list, mols_list):
